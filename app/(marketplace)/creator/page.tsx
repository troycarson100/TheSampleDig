  ...
  return (
    <FeatureGate fallback={<MarketplaceDisabled />}>
      <main className="mx-auto max-w-4xl px-6 py-12">
        <h1 className="text-3xl font-semibold mb-3">Creator Portal</h1>
        <p style={{ color: "var(--muted)" }}>
          Marketplace is enabled. This is the Phase 0 scaffold for upcoming creator tools.
        </p>
      </main>
    </FeatureGate>
  )
...
function MarketplaceDisabled() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p style={{ color: "var(--muted)" }}>
        Set <code>NEXT_PUBLIC_MARKETPLACE_ENABLED=true</code> to view creator routes.
      </p>
      <div className="mt-6">
